...
msDataTab <- function() {
    dat <- c("Raw", "Raw", "Identification", "Identification",
             "Quantitative", "Raw", "Peak lists", "Imaging", "Imaging")
    frmt <- c("mzXML or mzML", "mzXML or mzML",
              "mzIdentML", "mzIdentML", "mzTab",
              "mzXML or mzML", "mgf",
    ...
    pkg <- c("mzR", "MALDIquantForeign", "mzR", "mzID", "MSnbase",
