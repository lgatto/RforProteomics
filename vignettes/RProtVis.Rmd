...
The following code chunk downloads a MALDI imaging dataset from a mouse kidney
...
and generates a plot with the mean spectrum and three slices of interesting
*m/z* regions.
