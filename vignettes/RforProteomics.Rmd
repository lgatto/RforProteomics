...
Using example code/data from the `r Biocpkg("rTANDEM")`
vignette/package (not evaluated below), the following is an example of
a typical workflow

### Preparation of the input data {-}

```{r rtandem1, tidy = FALSE, eval = FALSE}
library(rTANDEM)
...
initiated and only a simple example will be given here (not evaluated):
